        ...
        <div className="bg-white text-gray-900 overflow-hidden">
            ...
            <section className="relative h-[60vh] flex items-center justify-center bg-gray-900 border-b border-gray-800 overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    >
                        Your Local <span className="text-brand-yellow uppercase">Mobile Repair Shop</span>
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                    ...
                    >
                        Looking for a trusted <strong className="text-white font-semibold">Lakemba mobile repair shop</strong>? We offer <strong className="text-white font-semibold">cheap mobile repair</strong> and premium accessories right in your neighborhood.
                    </motion.p>
                </div>
            </section>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        >
                            <div className="relative">
                                ...
                                <h2 className="text-4xl font-bold mb-8 text-gray-900 border-l-4 border-brand-blue pl-6">
                                    Expert <span className="text-brand-blue">Cell Phone Repair</span> in Lakemba
                                </h2>
                            </div>
                            <div className="space-y-6 text-lg text-gray-700 leading-relaxed font-light">
                                <p>
                                    At Lakemba Mobile King, we’re proud to be a reputable <strong className="text-gray-900 font-semibold">phone repair</strong> center conveniently located at Railway Parade. Whether you need a quick screen fix or deep hardware troubleshooting, we offer <strong className="text-gray-900 font-semibold">professional repair</strong> solutions tailored to your device.
                                </p>
                                <p>
                                    Our experienced technicians specialize in diagnosing and fixing modern devices. From shattered screens and battery degradation to motherboard issues, we handle fast <strong className="text-gray-900 font-semibold">iPhone repair</strong> and dependable <strong className="text-gray-900 font-semibold">Samsung repair</strong> using high-quality components and proven techniques.
                                </p>
                                <p className="font-medium text-gray-900 italic bg-gray-50 p-6 rounded-2xl border-l-4 border-brand-yellow">
                                    "We believe that a <strong className="text-brand-blue">cheap mobile repair</strong> shouldn't mean compromising on quality. That's our promise to the Lakemba community."
                                </p>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="aspect-square bg-gray-100 rounded-3xl overflow-hidden shadow-2xl relative">
                                ...
                                <img
                                    src="/lakemba-store.jpg"
                                    alt="Lakemba Mobile King Storefront"
