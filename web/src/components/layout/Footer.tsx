        ...
        <footer className="bg-gray-900 text-white pt-12 pb-6">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    {/* About */}
                    <div>
                        <h3 className="text-xl font-bold text-brand-yellow mb-4" style={{ fontFamily: 'var(--font-outfit)' }}>LAKEMBA MOBILE KING</h3>
                    ...
                    {/* Quick Links */}
                    <div>
                        <h3 className="text-lg font-bold mb-4" style={{ fontFamily: 'var(--font-outfit)' }}>Quick Links</h3>
                    ...
                    {/* Services */}
                    <div>
                        <h3 className="text-lg font-bold mb-4" style={{ fontFamily: 'var(--font-outfit)' }}>Our Services</h3>
                        <ul className="space-y-2 text-gray-400">
                    ...
                    {/* Contact */}
                    <div>
                        <h3 className="text-lg font-bold mb-4" style={{ fontFamily: 'var(--font-outfit)' }}>Contact Info</h3>
