(()=>{var e={};e.id=4024,e.ids=[4024],e.modules={10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},79428:e=>{"use strict";e.exports=require("buffer")},79646:e=>{"use strict";e.exports=require("child_process")},55511:e=>{"use strict";e.exports=require("crypto")},14985:e=>{"use strict";e.exports=require("dns")},94735:e=>{"use strict";e.exports=require("events")},29021:e=>{"use strict";e.exports=require("fs")},81630:e=>{"use strict";e.exports=require("http")},55591:e=>{"use strict";e.exports=require("https")},91645:e=>{"use strict";e.exports=require("net")},21820:e=>{"use strict";e.exports=require("os")},33873:e=>{"use strict";e.exports=require("path")},19771:e=>{"use strict";e.exports=require("process")},27910:e=>{"use strict";e.exports=require("stream")},41204:e=>{"use strict";e.exports=require("string_decoder")},66136:e=>{"use strict";e.exports=require("timers")},34631:e=>{"use strict";e.exports=require("tls")},79551:e=>{"use strict";e.exports=require("url")},28354:e=>{"use strict";e.exports=require("util")},74075:e=>{"use strict";e.exports=require("zlib")},78474:e=>{"use strict";e.exports=require("node:events")},61770:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>v,routeModule:()=>x,serverHooks:()=>f,workAsyncStorage:()=>h,workUnitAsyncStorage:()=>y});var o={};r.r(o),r.d(o,{POST:()=>b,runtime:()=>g});var s=r(42706),i=r(28203),a=r(45994),n=r(39187),p=r(56418),d=r(43345),l=r(28474),c=r(47579),u=r(17081),m=r(47811);let g="nodejs";async function b(e){try{let t;let r=await e.text(),o=e.headers.get("stripe-signature");if(!o)return n.NextResponse.json({error:"Missing stripe-signature header"},{status:400});let[s]=await d.db.select().from(l.settings).where((0,c.eq)(l.settings.key,"payment_settings")).limit(1);if(!s?.value)return n.NextResponse.json({error:"Payment settings not configured"},{status:500});let i=JSON.parse(s.value),a=i.stripe?.secretKey,g=i.stripe?.webhookSecret;if(!a||!g)return n.NextResponse.json({error:"Stripe credentials not configured"},{status:500});let b=new p.A(a,{apiVersion:"2025-12-15.clover"});try{t=b.webhooks.constructEvent(r,o,g)}catch(e){return console.error("Webhook signature verification failed:",e),n.NextResponse.json({error:"Invalid signature"},{status:400})}if("payment_intent.succeeded"===t.type){let e=t.data.object,r=e.metadata;if(r.tempReference&&!r.orderId){let t=r.tempReference,o=r.customerName||"Customer",s=r.customerEmail||"",i=r.customerPhone||"",a=r.customerAddress||"",n=parseFloat(r.total||"0"),p=parseFloat(r.subtotal||"0"),g=parseFloat(r.shipping||"0"),b=r.notes||"",x=[];try{x=JSON.parse(r.items||"[]")}catch(e){console.error("Failed to parse items from metadata:",e)}let h=(await d.db.insert(l.orders).values({orderNumber:t,customerName:o,customerEmail:s,customerPhone:i,shippingAddress:a,subtotal:p.toString(),shipping:g.toString(),total:n.toString(),status:"processing",paymentStatus:"paid",paymentMethod:"stripe",stripePaymentIntentId:e.id,notes:b,createdAt:new Date}))[0].insertId;for(let e of x)await d.db.insert(l.orderItems).values({orderId:h,productId:parseInt(e.id),productName:e.name,quantity:e.qty,price:String(e.price),total:String(e.price*e.qty)}),await d.db.update(l.products).set({stock:(0,u.ll)`${l.products.stock} - ${e.qty}`}).where((0,c.eq)(l.products.id,parseInt(e.id)));try{let[e]=await d.db.select().from(l.customers).where((0,c.eq)(l.customers.email,s)).limit(1);e?await d.db.update(l.customers).set({totalOrders:(0,u.ll)`${l.customers.totalOrders} + 1`,totalSpent:(0,u.ll)`${l.customers.totalSpent} + ${n}`,lastOrderDate:new Date,phone:i||e.phone,address:a||e.address}).where((0,c.eq)(l.customers.id,e.id)):await d.db.insert(l.customers).values({email:s,name:o,phone:i||null,address:a||null,totalOrders:1,totalSpent:n.toString(),lastOrderDate:new Date,source:"website"})}catch(e){console.error("Failed to update customer record in webhook:",e)}console.log(`Order ${t} created after successful Stripe payment`);try{await (0,m.m)({orderNumber:t,customerName:o,customerEmail:s,customerPhone:i,shippingAddress:a,items:x.map(e=>({productName:e.name,quantity:e.qty,price:e.price,total:e.price*e.qty})),subtotal:p,total:n,paymentMethod:"stripe"})}catch(e){console.error("Failed to send confirmation email:",e)}}else r.orderId&&(await d.db.update(l.orders).set({paymentStatus:"paid",status:"processing",paymentMethod:"stripe",stripePaymentIntentId:e.id}).where((0,c.eq)(l.orders.id,parseInt(r.orderId))),console.log(`Order ${r.orderId} marked as paid via Stripe webhook`))}if("payment_intent.payment_failed"===t.type){let e=t.data.object,r=e.metadata?.orderId;r&&(await d.db.update(l.orders).set({paymentStatus:"failed"}).where((0,c.eq)(l.orders.id,parseInt(r))),console.log(`Order ${r} payment failed`))}return n.NextResponse.json({received:!0})}catch(e){return console.error("Webhook error:",e),n.NextResponse.json({error:"Webhook handler failed"},{status:500})}}let x=new s.AppRouteRouteModule({definition:{kind:i.RouteKind.APP_ROUTE,page:"/api/webhooks/stripe/route",pathname:"/api/webhooks/stripe",filename:"route",bundlePath:"app/api/webhooks/stripe/route"},resolvedPagePath:"C:\\Users\\ADMIN\\OneDrive\\Documents\\PERSONAL\\DEVELOPMENTS\\LKM\\web\\src\\app\\api\\webhooks\\stripe\\route.ts",nextConfigOutput:"",userland:o}),{workAsyncStorage:h,workUnitAsyncStorage:y,serverHooks:f}=x;function v(){return(0,a.patchFetch)({workAsyncStorage:h,workUnitAsyncStorage:y})}},96487:()=>{},78335:()=>{},14120:(e,t,r)=>{"use strict";r.d(t,{J:()=>s});var o=r(98721);function s(e){let t="";switch(e){case"support":t=process.env.EMAIL_SUPPORT||"support@lakembamobileking.com.au";break;case"order":t=process.env.EMAIL_ORDER||"order@lakembamobileking.com.au";break;case"service":t=process.env.EMAIL_SERVICE||"service@lakembamobileking.com.au"}return{transporter:o.createTransport({host:process.env.SMTP_HOST||"smtp.hostinger.com",port:parseInt(process.env.SMTP_PORT||"465"),secure:!0,auth:{user:t,pass:process.env.SMTP_PASSWORD}}),user:t}}},47811:(e,t,r)=>{"use strict";r.d(t,{m:()=>s,r:()=>i});var o=r(14120);async function s(e){let{transporter:t,user:r}=(0,o.J)("order"),s=e.items.map(e=>`
            <tr>
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #f9fafb; padding: 20px; border: 1px solid #e5e7eb;">
            ...
            <div style="text-align: center; margin-top: 30px; padding: 25px; background: #eff6ff; border-radius: 12px; border: 1px solid #bfdbfe;">
                ...
                <a href="${process.env.NEXT_PUBLIC_APP_URL||"https://lakembamobileking.com.au"}/track-order/${e.orderNumber}" 
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #ffffff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 12px 12px;">
            ...
            <p style="color: #4b5563; line-height: 1.6;">Good news! We've dispatched your order <strong>${e.orderNumber}</strong>. It's now being handled by <strong>${s}</strong>.</p>
            ...
            <div style="grid-template-cols: 1fr 1fr; display: grid; gap: 20px; margin-top: 30px;">
                <div style="background: #f1f5f9; padding: 15px; border-radius: 8px;">
                    ...
                    <p style="margin: 0; font-weight: bold; color: #1e293b;">${s}</p>
                </div>
                <div style="background: #f1f5f9; padding: 15px; border-radius: 8px;">
    ...
    `;try{return await t.sendMail({from:`"Lakemba Mobile King" <${r}>`,to:e.customerEmail,subject:`Shipping Confirmation - Your order ${e.orderNumber} is on its way!`,html:i}),console.log("Shipped confirmation email sent to:",e.customerEmail),!0}catch(e){return console.error("Failed to send shipped confirmation email:",e),!1}}}};var t=require("../../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),o=t.X(0,[638,5352,5452,8721,6418,3887],()=>r(61770));module.exports=o})();