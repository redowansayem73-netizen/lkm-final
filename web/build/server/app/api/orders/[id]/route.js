(()=>{var e={};e.id=7413,e.ids=[7413],e.modules={10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},79428:e=>{"use strict";e.exports=require("buffer")},79646:e=>{"use strict";e.exports=require("child_process")},55511:e=>{"use strict";e.exports=require("crypto")},14985:e=>{"use strict";e.exports=require("dns")},94735:e=>{"use strict";e.exports=require("events")},29021:e=>{"use strict";e.exports=require("fs")},81630:e=>{"use strict";e.exports=require("http")},55591:e=>{"use strict";e.exports=require("https")},91645:e=>{"use strict";e.exports=require("net")},21820:e=>{"use strict";e.exports=require("os")},33873:e=>{"use strict";e.exports=require("path")},19771:e=>{"use strict";e.exports=require("process")},27910:e=>{"use strict";e.exports=require("stream")},41204:e=>{"use strict";e.exports=require("string_decoder")},66136:e=>{"use strict";e.exports=require("timers")},34631:e=>{"use strict";e.exports=require("tls")},79551:e=>{"use strict";e.exports=require("url")},28354:e=>{"use strict";e.exports=require("util")},74075:e=>{"use strict";e.exports=require("zlib")},78474:e=>{"use strict";e.exports=require("node:events")},79415:(e,r,t)=>{"use strict";t.r(r),t.d(r,{patchFetch:()=>f,routeModule:()=>g,serverHooks:()=>h,workAsyncStorage:()=>x,workUnitAsyncStorage:()=>b});var o={};t.r(o),t.d(o,{GET:()=>u,PATCH:()=>m});var i=t(42706),s=t(28203),a=t(45994),d=t(39187),n=t(43345),p=t(28474),l=t(47579),c=t(47811);async function u(e,{params:r}){try{let e;let{id:t}=await r;if(/^\d+$/.test(t)){let r=parseInt(t);[e]=await n.db.select().from(p.orders).where((0,l.eq)(p.orders.id,r)).limit(1)}else[e]=await n.db.select().from(p.orders).where((0,l.eq)(p.orders.orderNumber,t)).limit(1);if(!e)return d.NextResponse.json({error:"Order not found"},{status:404});let o=await n.db.select({id:p.orderItems.id,productId:p.orderItems.productId,productName:p.orderItems.productName,quantity:p.orderItems.quantity,price:p.orderItems.price,total:p.orderItems.total,refundedQuantity:p.orderItems.refundedQuantity}).from(p.orderItems).where((0,l.eq)(p.orderItems.orderId,e.id)),i=await n.db.select().from(p.orderRefunds).where((0,l.eq)(p.orderRefunds.orderId,e.id));return d.NextResponse.json({order:e,items:o,refunds:i})}catch(e){return console.error("Error fetching order:",e),d.NextResponse.json({error:"Failed to fetch order"},{status:500})}}async function m(e,{params:r}){try{let{id:t}=await r,o=parseInt(t),i=await e.json(),s={};if(i.status&&(s.status=i.status),i.paymentStatus&&(s.paymentStatus=i.paymentStatus),void 0!==i.paymentMethod&&(s.paymentMethod=i.paymentMethod),void 0!==i.notes&&(s.notes=i.notes),void 0!==i.trackingNumber&&(s.trackingNumber=i.trackingNumber),void 0!==i.shippingProvider&&(s.shippingProvider=i.shippingProvider),void 0!==i.customerName&&(s.customerName=i.customerName),void 0!==i.customerPhone&&(s.customerPhone=i.customerPhone),void 0!==i.shippingAddress&&(s.shippingAddress=i.shippingAddress),void 0!==i.stripePaymentIntentId&&(s.stripePaymentIntentId=i.stripePaymentIntentId),0===Object.keys(s).length)return d.NextResponse.json({error:"No valid fields to update"},{status:400});await n.db.update(p.orders).set(s).where((0,l.eq)(p.orders.id,o));let[a]=await n.db.select().from(p.orders).where((0,l.eq)(p.orders.id,o)).limit(1);if("shipped"===i.status&&a)try{let e=await n.db.select().from(p.orderItems).where((0,l.eq)(p.orderItems.orderId,a.id));await (0,c.r)({orderNumber:a.orderNumber||"",customerName:a.customerName||"",customerEmail:a.customerEmail||"",customerPhone:a.customerPhone||"",shippingAddress:a.shippingAddress||"",items:e.map(e=>({productName:e.productName||"",quantity:e.quantity||0,price:e.price||0,total:e.total||0})),subtotal:a.subtotal||0,total:a.total||0,shippingProvider:a.shippingProvider,trackingNumber:a.trackingNumber})}catch(e){console.error("Failed to send shipping email:",e)}return d.NextResponse.json({success:!0,order:a})}catch(e){return console.error("Error updating order:",e),d.NextResponse.json({error:"Failed to update order"},{status:500})}}let g=new i.AppRouteRouteModule({definition:{kind:s.RouteKind.APP_ROUTE,page:"/api/orders/[id]/route",pathname:"/api/orders/[id]",filename:"route",bundlePath:"app/api/orders/[id]/route"},resolvedPagePath:"C:\\Users\\ADMIN\\OneDrive\\Documents\\PERSONAL\\DEVELOPMENTS\\LKM\\web\\src\\app\\api\\orders\\[id]\\route.ts",nextConfigOutput:"",userland:o}),{workAsyncStorage:x,workUnitAsyncStorage:b,serverHooks:h}=g;function f(){return(0,a.patchFetch)({workAsyncStorage:x,workUnitAsyncStorage:b})}},96487:()=>{},78335:()=>{},14120:(e,r,t)=>{"use strict";t.d(r,{J:()=>i});var o=t(98721);function i(e){let r="";switch(e){case"support":r=process.env.EMAIL_SUPPORT||"support@lakembamobileking.com.au";break;case"order":r=process.env.EMAIL_ORDER||"order@lakembamobileking.com.au";break;case"service":r=process.env.EMAIL_SERVICE||"service@lakembamobileking.com.au"}return{transporter:o.createTransport({host:process.env.SMTP_HOST||"smtp.hostinger.com",port:parseInt(process.env.SMTP_PORT||"465"),secure:!0,auth:{user:r,pass:process.env.SMTP_PASSWORD}}),user:r}}},47811:(e,r,t)=>{"use strict";t.d(r,{m:()=>i,r:()=>s});var o=t(14120);async function i(e){let{transporter:r,user:t}=(0,o.J)("order"),i=e.items.map(e=>`
            <tr>
    ...
    `;try{return await r.sendMail({from:`"Lakemba Mobile King" <${t}>`,to:e.customerEmail,subject:`Order Confirmation - ${e.orderNumber}`,html:s}),console.log("Order confirmation email sent to:",e.customerEmail),!0}catch(e){return console.error("Failed to send order confirmation email:",e),!1}}async function s(e){let{transporter:r,user:t}=(0,o.J)("order"),i={aus_post:"Australia Post",sendle:"Sendle",startrack:"StarTrack",dhl:"DHL Express",other:"Our Carrier"}[e.shippingProvider||"other"]||"Our Carrier",s=`
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #ffffff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 12px 12px;">
            ...
            <p style="color: #4b5563; line-height: 1.6;">Good news! We've dispatched your order <strong>${e.orderNumber}</strong>. It's now being handled by <strong>${i}</strong>.</p>
            ...
            <div style="grid-template-cols: 1fr 1fr; display: grid; gap: 20px; margin-top: 30px;">
                <div style="background: #f1f5f9; padding: 15px; border-radius: 8px;">
                    ...
                    <p style="margin: 0; font-weight: bold; color: #1e293b;">${i}</p>
                </div>
                <div style="background: #f1f5f9; padding: 15px; border-radius: 8px;">
    ...
    `;try{return await r.sendMail({from:`"Lakemba Mobile King" <${t}>`,to:e.customerEmail,subject:`Shipping Confirmation - Your order ${e.orderNumber} is on its way!`,html:s}),console.log("Shipped confirmation email sent to:",e.customerEmail),!0}catch(e){return console.error("Failed to send shipped confirmation email:",e),!1}}}};var r=require("../../../../webpack-runtime.js");r.C(e);var t=e=>r(r.s=e),o=r.X(0,[638,5352,5452,8721,3887],()=>t(79415));module.exports=o})();